...
public class SoundingTextButton extends TextButton {
    public SoundingTextButton(String text, Skin skin) {
        this(text, skin, "sfx.ui.hover", "sfx.ui.click");
    }

    public SoundingTextButton(String text, Skin skin, String hoverSoundId, String clickSoundId) {
        super(text, skin);
