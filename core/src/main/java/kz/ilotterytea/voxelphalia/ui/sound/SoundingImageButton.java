...
public class SoundingImageButton extends ImageButton {
    public SoundingImageButton(Skin skin, String styleName) {
        this(skin, styleName, "sfx.ui.hover", "sfx.ui.click");
    }

    public SoundingImageButton(Skin skin, String styleName, String hoverSoundId, String clickSoundId) {
