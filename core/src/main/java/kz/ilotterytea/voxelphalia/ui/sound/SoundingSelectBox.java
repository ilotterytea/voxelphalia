...
public class SoundingSelectBox<T> extends SelectBox<T> {
    public SoundingSelectBox(Skin skin) {
        this(skin, "sfx.ui.hover", "sfx.ui.click");
    }

    public SoundingSelectBox(Skin skin, String hoverSoundId, String clickSoundId) {
        super(skin);
