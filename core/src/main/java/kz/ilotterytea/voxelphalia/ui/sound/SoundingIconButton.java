...
public class SoundingIconButton extends IconButton {
    public SoundingIconButton(String text, Image icon, Skin skin) {
        this(text, icon, skin, "sfx.ui.hover", "sfx.ui.click");
    }

    public SoundingIconButton(String text, Image icon, Skin skin, String hoverSoundId, String clickSoundId) {
